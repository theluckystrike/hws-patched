...
static void VideoScaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h, int out_w,
			int out_h);
static void FHD_To_HD_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
			     int out_w, int out_h);
static void HD_To_FHD_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
			     int out_w, int out_h);
...
static void SD_NTSC_To_FHD_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
				  int out_w, int out_h);
static void SD_NTSC_To_HD_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
				 int out_w, int out_h);
static void V1280X1024_To_FHD_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
				     int out_w, int out_h);
static void V1280X1024_To_HD_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
				    int out_w, int out_h);
static void V1280X1024_To_800X600_Scaler(BYTE *pSrc, BYTE *pOut, int in_w,
					 int in_h, int out_w, int out_h);
static void FHD_To_SD_NTSC_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
				  int out_w, int out_h);
static void FHD_To_SD_PAL_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
				 int out_w, int out_h);
static void HD_To_SD_NTSC_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
				 int out_w, int out_h);
static void HD_To_SD_PAL_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
				int out_w, int out_h);
static void V1280X1024_NTSC_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
				   int out_w, int out_h);
static void V1280X1024_PAL_Scaler(BYTE *pSrc, BYTE *pOut, int in_w, int in_h,
				  int out_w, int out_h);
...
//-----------------------------------
static void ChangeVideoSize(struct hws_pcie_dev *pdx, int ch, int w, int h,
			    int interlace)
{
	int j;
	int halfframeLength;
